...
//            }
    ...
    override fun searchSchedule(query: String): Flow<List<Schedule>> = flow {
        try {
            val scheduleInfo = api.getSearchSchedule(query)
            ...
            Log.d("PLANJDEBUG", "searchSchedule error  ${e.message}")
        }
    }
